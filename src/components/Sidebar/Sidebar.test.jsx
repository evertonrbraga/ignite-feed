...
describe("<Sidebar />", () => {
  it("should check if the .sidebar wrapper is rendering correctly", () => {
    render(<Sidebar />);
    const sidebarWrapper = document.querySelector(".sidebar");
    expect(sidebarWrapper).toBeInTheDocument();
  });

  it("should check if the images are rendering correctly", () => {
    render(<Sidebar />);
  ...
  it("should check if the footer and its contents is rendering correctly", () => {
